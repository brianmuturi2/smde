...
import { approved_documents_url } from '../../app.constants';
import { Subject } from 'rxjs';
import { DocumentsList } from '../interfaces/survey';
import { Router } from '@angular/router';
@Component({
  selector: 'app-approved-documents',
  templateUrl: './approved-documents.component.html',
  styleUrls: ['./approved-documents.component.css']
})
export class ApprovedDocumentsComponent implements OnInit {
  ...
  fetchRecords(){
    this.loadingService.showloading();
     this.surveyService.getrecord(approved_documents_url).subscribe((res)=>{
       this.records = res;
