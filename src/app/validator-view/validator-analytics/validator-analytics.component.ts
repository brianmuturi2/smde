...
import { data_validators_analytics_url } from '../../app.constants';
...
export class ValidatorAnalyticsComponent implements OnInit {
  ...
  fetch_records = [];
  constructor(public validatorService: ValidatorService, private formBuilder: FormBuilder,
  ...
  fetchdashboardrecords(payload ) {
    ...
    this.validatorService.getrecords(data_validators_analytics_url, payload).subscribe((res) => {
      this.destroy_chart();
