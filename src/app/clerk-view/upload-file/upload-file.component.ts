...
documentName:string;
fileData:File = null;
  constructor(public loadingService:LoadingService,private router: Router,public surveyService:SurveyService,private toastService:ToastService,public sweetalertsService:SweetalertService) { }
